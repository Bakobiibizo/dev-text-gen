...
func ShowHandler(cmd *cobra.Command, args []string) error {
	...
	if flagsSet > 1 {
		return errors.New("only one of '--license', '--modelfile', '--parameters', '--system', or '-' can be specified")
	} else if flagsSet == 0 {
		return errors.New("one of '--license', '--modelfile', '--parameters', '--system', or '-' must be specified")
	}
